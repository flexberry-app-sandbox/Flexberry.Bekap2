...
namespace IIS.Bekap_2
{
    ...
    [View("СоставУслугиE", new string[] {
            ...
            "Товар as \'Товар\'",
            "Товар.Производитель as \'Производитель\'"}, Hidden=new string[] {
            "Товар.Производитель"})]
    ...
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Bekap_2.Товар fТовар;
        ...
        [PropertyStorage(new string[] {
                "Товар"})]
        [NotNull()]
        public virtual IIS.Bekap_2.Товар Товар
        {
            get
            {
                ...
                IIS.Bekap_2.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Bekap_2.Услуга.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.Bekap_2.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Bekap_2.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.Bekap_2.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.Bekap_2.Услуга fУслуга) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fУслуга)))
        {
        }
        
        public IIS.Bekap_2.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.Bekap_2.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Bekap_2.СоставУслуги dataobject)
        {
